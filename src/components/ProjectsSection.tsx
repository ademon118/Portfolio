  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto relative z-10">
        <ScrollReveal className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 sm:gap-6 mb-8 sm:mb-12">
          <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5 sm:gap-8">
          {projects.map((project, index) => (
            <ScrollReveal key={project.slug} delayMs={index * 80}>
              <article
                className="project-card-motion group relative h-full bg-gradient-to-br from-white/5 to-white/[0.02] border border-white/10 rounded-3xl p-4 sm:p-6 flex flex-col overflow-hidden hover:border-blue-400/60 hover:shadow-[0_12px_40px_rgba(59,130,246,0.28)] cursor-pointer"
              >
                <Link
                ...
                <div className="relative z-[2] pointer-events-none flex items-center justify-between gap-3 mb-4">
                  <div className="flex items-center gap-3">
                    <div className="w-11 h-11 shrink-0 rounded-2xl bg-gradient-to-br from-blue-500/30 to-purple-500/30 border border-white/20 flex items-center justify-center text-2xl shadow-lg shadow-blue-500/30 transition-transform duration-300 group-hover:scale-110 group-hover:-rotate-3">
                ...
                <div className="relative z-[2] pointer-events-none flex flex-wrap gap-2 mb-5">
                  {project.tech.slice(0, 4).map((tech) => (
                    <span
                      key={tech}
                      className="px-2.5 py-1 rounded-full bg-white/5 border border-white/10 text-xs text-gray-200/90 transition-colors group-hover:border-blue-400/30"
                    >
                      {tech}
                    </span>
                  ))}
                ...
                <div className="relative z-[2] mt-auto flex items-center justify-between gap-3 pt-4 border-t border-white/10">
                  ...
                  <span className="pointer-events-none inline-flex items-center gap-1.5 text-xs text-gray-200 group-hover:text-white transition-colors">
                    ...
                    <span className="inline-flex h-5 w-5 items-center justify-center rounded-full bg-white/10 border border-white/20 group-hover:bg-blue-500 group-hover:border-blue-300 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all">
                      <svg
