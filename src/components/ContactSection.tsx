      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10 text-center w-full">
        <ScrollReveal>
          <div className="flex justify-center items-center gap-2 sm:gap-4 md:gap-6 mb-4 sm:mb-8">
            <div className="w-10 h-10 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-transparent border-2 border-blue-400/30 rounded-xl flex items-center justify-center hover:border-blue-400/60 hover:-translate-y-1 transition-all duration-300 cursor-pointer">
            ...
            <div className="relative">
              <div className="w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20 bg-blue-500 rounded-xl flex items-center justify-center shadow-2xl shadow-blue-500/50 border-2 border-blue-400 cursor-pointer transform hover:scale-105 hover:-translate-y-1 transition-all duration-300">
        ...
        <ScrollReveal delayMs={260}>
          <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 justify-center px-4">
            <button
              ...
              className="w-full sm:w-auto bg-white text-black px-8 py-3 rounded-full hover:bg-gray-200 transition-all duration-300 transform hover:scale-105 hover:-translate-y-0.5 shadow-lg shadow-white/10 font-medium"
            >
              Contact Me
            </button>
            <button
